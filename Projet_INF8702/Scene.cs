...
namespace Projet_INF8702
{
    class Scene : Common.RendererBase
    {
        ...
        public Scene()
        {
            ...
            Lights.Add(new DirectionalLight { Direction = new Vector3(1f, -1f, -1f), Color = Color.YellowGreen, IsOn = true });
            Lights.Add(new PointLight { Direction = new Vector3(1f, -1f, -1f), Position = new Vector3(), Color = Color.Gray, IsOn = false });
            Lights.Add(new SpotLight { Direction = new Vector3(1f, -1f, -1f), Position = new Vector3(), SpotDirection = new Vector3(), SpotExponent = 0.0f, Color = Color.Gold, IsOn = false });
        ...
        private void LightScene(ref ConstantBuffers.PerFrame perFrame)
        {
            ...
            perFrame.Light.Direction = new Vector3(lightDir0.X, lightDir0.Y, lightDir0.Z);
            ...
            perFrame.Light.Color = dirLight.Color;
