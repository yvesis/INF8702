...
namespace LoadMeshes.Application
{
    class SkyBox : PrimitivesRenderer
    {
        ...
        protected override void CreateDeviceDependentResources()
        {
            ...
            textureCube = ToDispose(ShaderResourceView.FromFile(DeviceManager.Direct3DDevice, "Textures/2.dds"));
            ...
            perSkyBox = ToDispose(new Buffer(DeviceManager.Direct3DDevice, Utilities.SizeOf<ConstantBuffer.DrawSkyBox>(), ResourceUsage.Default, BindFlags.ConstantBuffer, CpuAccessFlags.None, ResourceOptionFlags.None, 0));
            DeviceManager.Direct3DContext.PixelShader.SetConstantBuffer(3, perSkyBox);
